...
//			    		  			  , fileType: DigiWebApp.ApplicationController.CONSTAudioFiletype
//			    		  		}));
...
//		    		    		DigiWebApp.BautagebuchMedienDetailsController.set("fileType", DigiWebApp.ApplicationController.CONSTAudioFiletype);
...
//		    		    		DigiWebApp.BautagebuchMedienDetailsController.set("item", DigiWebApp.BautagebuchMediaFile.createRecord({
//			    		  			    bautagesberichtId: DigiWebApp.BautagebuchBautageberichtDetailsController.item.m_id
//			    		  			  , fileType: DigiWebApp.ApplicationController.CONSTVideoFiletype
//			    		  		}));
//		    		    		DigiWebApp.BautagebuchMedienDetailsController.set("positionId", null);
//		    		    		DigiWebApp.BautagebuchMedienDetailsController.set("positionName", null);
//		    		    		DigiWebApp.BautagebuchMedienDetailsController.set("activityId", null);
...
//		    		    		DigiWebApp.BautagebuchMedienDetailsController.set("data", null);
//		    		    		DigiWebApp.BautagebuchMedienDetailsController.set("remark", null);
//		    		    		DigiWebApp.BautagebuchMedienDetailsController.set("fileType", DigiWebApp.ApplicationController.CONSTVideoFiletype);
//			    		  		DigiWebApp.NavigationController.toBautagebuchMedienDetailsPageTransition();
		    		            break;
		    		        case 'other':
		    		            DigiWebApp.ApplicationController.nativeAlertDialogView({
	...
	, regSecEv: function(isFirstLoad) {
		...
		if (this.skipEvents) {
        	...
        	if (typeof(device) === "undefined") { 
        		...
        		// or start deviceready-handler after a timeout of 8 seconds (we are not on a mobile device)
            ...
            _.each(data['return'], function(el, i) {
            	...
            	if (el[prefix + 'valueType'] === "Setting_WebApp") {
	                ...
	                if ((el[prefix + 'value'] === "true" && !activeFeatureFound) || (el[prefix + 'value'] === "false" && activeFeatureFound)) {
	                	if (el[prefix + 'keyId'] === "400") DigiWebApp.ApplicationController.restartApp = YES;
	                	if (el[prefix + 'keyId'] === "401") DigiWebApp.ApplicationController.restartApp = YES;
	                	//if (el[prefix + 'keyId'] === "402") DigiWebApp.ApplicationController.restartApp = YES;
	                	if (el[prefix + 'keyId'] === "403") DigiWebApp.ApplicationController.restartApp = YES;
	                	//if (el[prefix + 'keyId'] === "404") DigiWebApp.ApplicationController.restartApp = YES;
	                	if (el[prefix + 'keyId'] === "405") DigiWebApp.ApplicationController.restartApp = YES;
	                	if (el[prefix + 'keyId'] === "406") DigiWebApp.ApplicationController.restartApp = YES;
	                	//if (el[prefix + 'keyId'] === "407") DigiWebApp.ApplicationController.restartApp = YES;
	                	if (el[prefix + 'keyId'] === "408") DigiWebApp.ApplicationController.restartApp = YES;
	                	if (el[prefix + 'keyId'] === "409") DigiWebApp.ApplicationController.restartApp = YES;
    ...
    , content: M.ScrollView.design({
        ...
        , order: M.LabelView.design({
            computedValue: {
              ...
              , operation: function(v) {
      	  			if (DigiWebApp.ZeitbuchungenController.itemForDetails !== null) {
      					if (DigiWebApp.ZeitbuchungenController.itemForDetails.get("auftragsBezeichnung") !== "" && typeof(DigiWebApp.ZeitbuchungenController.itemForDetails.get("auftragsBezeichnung")) !== "undefined") {
        ...
        , position: M.LabelView.design({
            computedValue: {
              ...
              , operation: function(v) {
      	  			if (DigiWebApp.ZeitbuchungenController.itemForDetails !== null) {
      					if (DigiWebApp.ZeitbuchungenController.itemForDetails.get("positionsBezeichnung") !== "" && typeof(DigiWebApp.ZeitbuchungenController.itemForDetails.get("positionsBezeichnung")) !== "undefined") {
      						//$('#' + DigiWebApp.ZeitbuchungDetailsPage.content.infoButton.id).button("enable");
...
//            		}
        ...
        , handApplications: M.LabelView.design({
            computedValue: {
              ...
              , operation: function(v) {
      	  			if (DigiWebApp.ZeitbuchungenController.itemForDetails !== null) {
      					if (DigiWebApp.ZeitbuchungenController.itemForDetails.get("handauftragsBezeichnung") !== "" && typeof(DigiWebApp.ZeitbuchungenController.itemForDetails.get("handauftragsBezeichnung")) !== "undefined") {
        ...
        , activity: M.LabelView.design({
            computedValue: {
              ...
              , operation: function(v) {
      	  			if (DigiWebApp.ZeitbuchungenController.itemForDetails !== null) {
      					if (DigiWebApp.ZeitbuchungenController.itemForDetails.get("taetigkeit") !== "" && typeof(DigiWebApp.ZeitbuchungenController.itemForDetails.get("taetigkeit")) !== "undefined") {
        ...
        , activityPositionInWorkplan: M.LabelView.design({
            computedValue: {
              ...
              , operation: function(v) {
      	  			if (DigiWebApp.ZeitbuchungenController.itemForDetails !== null) {
      					if (DigiWebApp.ZeitbuchungenController.itemForDetails.get("taetigkeitreihenfolge") !== "" && typeof(DigiWebApp.ZeitbuchungenController.itemForDetails.get("taetigkeitreihenfolge")) !== "undefined") {
        ...
        , remark: M.LabelView.design({
            computedValue: {
              ...
              , operation: function(v) {
      	  			if (DigiWebApp.ZeitbuchungenController.itemForDetails !== null) {
      					if (DigiWebApp.ZeitbuchungenController.itemForDetails.get("remark") !== "" && typeof(DigiWebApp.ZeitbuchungenController.itemForDetails.get("remark")) !== "undefined") {
        ...
        , gpsBreite: M.LabelView.design({
            computedValue: {
              ...
              , operation: function(v) {
      	  			if (DigiWebApp.ZeitbuchungenController.itemForDetails !== null) {
      					if (DigiWebApp.ZeitbuchungenController.itemForDetails.get("gpsBreite") !== "" && typeof(DigiWebApp.ZeitbuchungenController.itemForDetails.get("gpsBreite")) !== "undefined" && DigiWebApp.ZeitbuchungenController.itemForDetails.get("gpsBreite") !== "0.0") {
        ...
        , gpsLaenge: M.LabelView.design({
            computedValue: {
              ...
              , operation: function(v) {
      	  			if (DigiWebApp.ZeitbuchungenController.itemForDetails !== null) {
      					if (DigiWebApp.ZeitbuchungenController.itemForDetails.get("gpsLaenge") !== "" && typeof(DigiWebApp.ZeitbuchungenController.itemForDetails.get("gpsLaenge")) !== "undefined" && DigiWebApp.ZeitbuchungenController.itemForDetails.get("gpsLaenge") !== "0.0") {
      						$('#' + DigiWebApp.ZeitbuchungDetailsPage.content.showBookingCoordinatesInMapButton.id).show()
        ...
        , gpsBreitePosition: M.LabelView.design({
            computedValue: {
              ...
              , operation: function(v) {
      	  			if (DigiWebApp.ZeitbuchungenController.itemForDetails !== null) {
      					if (DigiWebApp.ZeitbuchungenController.itemForDetails.get("gpsBreitePosition") !== "" && typeof(DigiWebApp.ZeitbuchungenController.itemForDetails.get("gpsBreitePosition")) !== "undefined" && DigiWebApp.ZeitbuchungenController.itemForDetails.get("gpsBreitePosition") !== "0.0") {
        ...
        , gpsLaengePosition: M.LabelView.design({
            computedValue: {
              ...
              , operation: function(v) {
      	  			if (DigiWebApp.ZeitbuchungenController.itemForDetails !== null) {
      					if (DigiWebApp.ZeitbuchungenController.itemForDetails.get("gpsLaengePosition") !== "" && typeof(DigiWebApp.ZeitbuchungenController.itemForDetails.get("gpsLaengePosition")) !== "undefined" && DigiWebApp.ZeitbuchungenController.itemForDetails.get("gpsLaengePosition") !== "0.0") {
      						$('#' + DigiWebApp.ZeitbuchungDetailsPage.content.showPositionCoordinatesInMapButton.id).show()
...
DigiWebApp.SettingsPage = M.PageView.design({
    ...
    , content: M.ScrollView.design({
        //  childViews: 'companyGrid passwordGrid connectionCodeGrid workerIdGrid autoTransferAfterBookTimeCheck autoTransferAfterClosingDayCheck autoSyncAfterBookTimeCheck remarkIsMandatory autoSaveGPSData GPSDataIsMandatory useTransitionsSetting grid'
          childViews: 'companyGrid passwordGrid connectionCodeGrid workerIdGrid autoTransferAfterBookTimeCheck autoTransferAfterClosingDayCheck autoSyncAfterBookTimeCheck remarkIsMandatory autoSaveGPSData useTransitionsSetting daysToHoldBookingsOnDeviceSliderContainer bautagebuchLimit_autoStartUhrzeit grid'
					    	...
					    	M.DialogView.actionSheet({
						        ...
						        , callbacks: {
					    			...
					    			, other: {action: function(buttonTag) {
					    			    switch(buttonTag) {
						    		        case 'finish':
						    		        	DigiWebApp.BautagebuchBautageberichtDetailsController.finish(DigiWebApp.NavigationController.backToBautagebuchBautageberichteListePageTransition);
						    		            break;
						    		        default:
						    		            console.log("unknonw ButtonTag");
						    		            break;
